"""
Django settings for bandung_couture project.
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'debug.log',  # Nama file log
        },
    },
    'loggers': {
        'django': {
        ...
        'your_app_name': {  # Ganti dengan nama aplikasi Anda
            'handlers': ['file'],
            'level': 'DEBUG',
            'propagate': False,
        },
...
ROOT_URLCONF = 'bandung_couture.urls'
